...
export default function Notification({show, onClose, message}) {
    ...
    return(
      ...
      >
        <div className="w-full flex z-50 flex-col items-center space-y-4 sm:items-end">
              ...
              <div className="p-4">
                <div className="flex items-start">
                  ...
                  <div className="ml-3 w-0 flex-1 pt-0.5">
                    <p className="text-sm font-medium text-gray-900">Operatiune completa!</p>
