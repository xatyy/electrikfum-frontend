          ...
          <div className="lg:grid lg:grid-cols-12 lg:auto-rows-min lg:gap-x-8">
            ...
            <div className="mt-8 space-y-6 lg:col-span-5">
                ...
                <button
                  ...
                  className={classNames( data?.attributes.stock  ? "mt-2 w-full bg-indigo-600 border border-transparent rounded-md py-3 px-8 flex items-center justify-center text-base font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" : 
                  "mt-2 w-full bg-neutral-200 border border-transparent rounded-md py-3 px-8 flex items-center justify-center text-base font-medium text-neutral-700 disabled cursor-not-allowed opacity-70")}
                  
                >
                  {data?.attributes.stock  ? "Adaugă în coș" : "Ne cerem scuze, produsul nu mai este în stoc."}
                </button>
                <div className={data?.attributes.stock ? "quantity space-x-10 items-center inline-flex":"hidden"}>
                      <button
                      onClick={() => setQuantity((prev) => prev === data?.attributes.stock ? prev : prev+1)}
                      className={quantity === data?.attributes.stock ? "w-10 h-10 text-white rounded-lg bg-indigo-600  opacity-60 cursor-not-allowed" : "w-10 h-10 text-white rounded-lg bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"}>
                        +
                      </button>
                      <div>
                      {quantity}
                      ...
                      className="w-10 h-10 text-white rounded-lg bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                        -
                      </button>
                  </div>
              ...
              <section aria-labelledby="policies-heading" className="mt-10 space-y-2">
                ...
                <div className={classNames(
                   data?.attributes.hasNic ? "border-black border-[4px] max-w-sm lg:max-w-screen-2xl mx-auto w-full h-auto text-2xl flex justify-center font-arimo text-center" : "hidden"
                   )}>
